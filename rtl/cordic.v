...
module	cordic(i_clk, i_reset, i_ce, i_xval, i_yval, i_phase, i_aux,
	...
	localparam	IW= 8,	// The number of bits in our inputs
			...
			WW=13,	// Our working bit-width
			PW=17;	// Bits in our phase variables
	...
	//
	wire	[16:0]	cordic_angle [0:(NSTAGES-1)];

	assign	cordic_angle[ 0] = 17'h0_25c8; //  26.565051 deg
	assign	cordic_angle[ 1] = 17'h0_13f6; //  14.036243 deg
	assign	cordic_angle[ 2] = 17'h0_0a22; //   7.125016 deg
	assign	cordic_angle[ 3] = 17'h0_0516; //   3.576334 deg
	assign	cordic_angle[ 4] = 17'h0_028b; //   1.789911 deg
	assign	cordic_angle[ 5] = 17'h0_0145; //   0.895174 deg
	assign	cordic_angle[ 6] = 17'h0_00a2; //   0.447614 deg
	assign	cordic_angle[ 7] = 17'h0_0051; //   0.223811 deg
	assign	cordic_angle[ 8] = 17'h0_0028; //   0.111906 deg
	assign	cordic_angle[ 9] = 17'h0_0014; //   0.055953 deg
	assign	cordic_angle[10] = 17'h0_000a; //   0.027976 deg
	assign	cordic_angle[11] = 17'h0_0005; //   0.013988 deg
	assign	cordic_angle[12] = 17'h0_0002; //   0.006994 deg
	// Std-Dev    : 0.00 (Units)
	// Phase Quantization: 0.000094 (Radians)
	// Gain is 1.164435
	// You can annihilate this gain by multiplying by 32'hdbd95b1f
